...
class FigureJR270Command : FigureCommand {
    ...
    private fun getFourthPolygon(
        ...
        val bottomY = config.startY + config.originalBlockSize - config.originalBlockOffset / 2f
    ...
    private fun getThirdPolygon(
        ...
        val bottomY = config.startY + config.originalBlockSize * 3 + config.originalBlockOffset + 2
